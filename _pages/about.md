...
<div style="overflow: hidden; clear: both;">
    <img src="images\teaser_video_for_twitter.gif" alt="Dextouch_teaser" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
...
<div style="overflow: hidden; clear: both;">
    <img src="images\visual_tactile.avif" alt="visual_tactile" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
    <div style="margin-left: 120px;">
...
<div style="overflow: hidden; clear: both;">
    <img src="images\ESwA_force_estimation.jpg" alt="force_estimation" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
    <div style="margin-left: 120px;">
...
<div style="overflow: hidden; clear: both;">
    <img src="images\deep_touch.jpg" alt="deep_touch" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
    <div style="margin-left: 120px;">
...
<br>
<div style="overflow: hidden; clear: both;">
    <img src="images\proprioception.jpg" alt="proprioception" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
    <div style="margin-left: 120px;">
...
<div style="overflow: hidden; clear: both;">
    <img src="images\iros.avif" alt="iros_2021" style="float: left; margin-right: 10px; margin-bottom: 40px; width: 20%">
    <div style="margin-left: 120px;">
